...
def write_webgpu_consts() -> None:
    ...
    compatibility_consts: list[tuple[str, str, int]] = [
        ...
        ("WGPUFeatures_ExperimentalMeshShader", "UInt64", 0x0001000000000000),
        ("WGPUFeatures_ExperimentalMeshShaderPoints", "UInt64", 0x0080000000000000),
        ("WGPUFeatures_QueryableMask", "UInt64", 0x0081406010010001),
