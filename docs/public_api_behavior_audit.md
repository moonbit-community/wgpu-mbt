...
2. `Device::create_pipeline_layout_immediates_many(...)` now has an
   immediates behavior test in
   [`src/tests/wgpu_immediates_test.mbt`](../src/tests/wgpu_immediates_test.mbt).
